    ...
    protected function eventRules(): array
    {
        return [
            'organizer_id' => [
                'required',
                'integer',
                // Admins are accepted alongside real organizer accounts: see
                // EventController::organizers(), which falls back to the
                // current admin when no organizer-role account exists yet.
