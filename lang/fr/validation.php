...
return [
    ...
    */
    ...
    'missing_unless' => 'Le champ :attribute doit être manquant à moins que :other ne vaille :value.',
    ...
    */
    ...
    'custom' => [
        // organizer_id needs no override here: the generic 'required' line
        // above, combined with the 'organisateur' label in 'attributes'
        // below, already renders as "Le champ organisateur est obligatoire."

        'cover_image' => [
            // Kept in sync by hand with StoreEventRequest/UpdateEventRequest's
            // 'cover_image' => ['image', ..., 'max:5120'] rule (5120 KB = 5 Mo).
            // The generic max.file line can't express "Mo" (it's always
            // "kilo-octets"), hence this override.
    ...
    */
    ...
    'attributes' => [
        // Admin event form (App\Concerns\EventValidationRules)
        ...
        'ticket_types.*.name' => 'nom du type de billet',
        'ticket_types.*.price' => 'prix du type de billet',

        // Guest checkout (App\Http\Requests\Public\StoreCheckoutRequest)
        'buyer_name' => 'nom complet',
        'buyer_email' => 'adresse email',
        'buyer_phone' => 'numéro de téléphone',
        'items' => 'billets sélectionnés',
        'items.*.ticket_type_id' => 'type de billet',
        'items.*.quantity' => 'quantité',

        // Scanner API (App\Http\Requests\Api\V1\Scanner\*)
        'email' => 'adresse email',
        ...
        // Email two-factor challenge (App\Http\Requests\Auth\VerifyTwoFactorEmailCodeRequest)
        'code' => 'code',
    ],
